...
class DataLoaderTester(unittest.TestCase):
    def test_dataloader(self):
        ...
        self.assertEqual(train_batch["image"].shape, (8, 224, 224, 3))
        self.assertEqual(train_batch["label"].shape, (8))
        ...
        self.assertEqual(val_batch["image"].shape, (8, 224, 224, 3))
        self.assertEqual(val_batch["label"].shape, (8))
